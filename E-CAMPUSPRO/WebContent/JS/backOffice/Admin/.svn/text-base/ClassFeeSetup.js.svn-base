					...
					$('#excelDownload')
							.click(
									function() {
										...
										var searchTerm = $("#classfeesetupsearchid").val()
										.trim();


										window.location.href = 'classfeesetup.html?method=downloadclassfeesetupXLS&searchTerm='
											+ searchTerm;
					...
					$("#pdfDownload")
							.click(
									function() {
										...
										window.location.href = "classfeesetup.html?method=downloadclassfeesetupPDF&searchTerm="
												+ searchTerm;
					...
					$("#search")
							.click(
									function() {
										...
										window.location.href = "adminMenu.html?method=getClassFeeSetup&searchTerm="
												+ searchTerm;
							...
							.click(
									function() {
										...
										if (count > 1 || count == 0) {
											...
											window.location.href = "classfeesetup.html?method=getEditedFeeSetupDetails&FeeCode="
													+ feecode;
							...
							.click(
									function() {
										...
										if (tot != 0) {
											...
											document.location.href = "classfeesetup.html?method=insertApproveFees&FeeCode="
													+ yearID
													+ ","
													+ classID
													+ ","
									...
									function() {
										...
										if (feecodearray.length != 0) {
											...
											if (count > 0) {
												...
												document.location.href = "classfeesetup.html?method=insertFeeAmount&FeeCodeArray="
														+ feecodearray
														+ "&FeeArray="
														+ feearray
														+ "&classid="
...
function deleteFee(val1) {
	...
	if (x) {
		...
		window.location.href = "classfeesetup.html?method=deleteFees&FeeSettingsCode="
				+ split_id[0].trim()
				+ "&FeeCode="
				+ split_id[1].trim()
				+ "&acadamicYear="
