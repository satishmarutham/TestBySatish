		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					<span id="addleavebank" class="glyphicon glyphicon-plus"
						data-toggle="tooltip" data-placement="bottom" title="Add"></span>

					</a> <span id="editleavebank" class="glyphicon glyphicon-pencil"
						data-toggle="tooltip" data-placement="bottom" title="Edit"></span>



					<span  id="deleteleavebank" onclick="deleteLeave()"  class="glyphicon glyphicon-trash"
