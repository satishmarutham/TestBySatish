									...
									<logic:present name="classList" scope="request">
										<logic:iterate name="classList" id="datalist" scope="request">
											<tr class="accordHead">
												...
												<td><span class="glyphicon glyphicon-pencil addExam"
													style="color: #9E9797;border-right: 0px solid #ddd;"
													id="<bean:write name="datalist" property="classId" />,<bean:write name="calMap" property="examId"/>"></span></td>
											</tr>
										</logic:iterate>
									</logic:present>
								</table>
