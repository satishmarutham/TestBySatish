			...
			<div class="panel panel-primary">
				<div class="panel-heading" role="tab" id="headingOne">
					...
					<div class="navbar-right">
						<span id="examcreateid" class="save2"><img
							src="images/save.png" data-toggle="tooltip"
							data-placement="bottom" title="Save"> </span> <a
							href="adminMenu.html?method=examList"><span
				...
				<br> <input type="hidden" name="examid" class="examidclass"
					id="examId"
						...
						<div class="col-md-6" id="txtstyle">
							...
							<div class="form-group">
								<label for="inputPassword" class="control-label col-xs-4"
									...
									Year </label>
								<div class="col-xs-7">
									<select name="accyear" id="accyear" class="form-control">
