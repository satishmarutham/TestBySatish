		...
		<div class="col-md-7" id="div2">
			...
			<p style="margin: 16px 0px;">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Stage Fee Setup</span>
			</p>
			...
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Stage Fee Setup
				...
				<div class="navbar-right" >
					...
					<span class="glyphicon glyphicon-plus" id="insert"
					 ...
					 <a href="adminMenu.html?method=getStageFeeSetup"> <span class="glyphicon glyphicon-list" 
