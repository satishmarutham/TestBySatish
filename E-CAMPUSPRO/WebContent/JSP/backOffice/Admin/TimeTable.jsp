...
<body>
	<div class="col-md-10"
		...
		<div class="input-group col-md-5">
			...
			<label  class="hedderstyle form-control" style="margin: 20px 0px; width: 18% !important; border: none;font-family:Roboto Medium; font-size: 14px;font-weight:lighter;margin-left: 4% !important">Class</label> 
			...
			<label style="margin: 20px 0px; width:  18% !important; border: none;font-family:Roboto Medium; font-size: 14px;font-weight:lighter;"
				class="form-control">Section</label>
				
			<input type="text" name="section" style="width: 30%; margin: 20px 0px; margin-left: 0%;"
											id="section" maxlength="25" class="form-control"  readonly="readonly"
