				...
				<div class="panel-heading" role="tab" id="headingOne">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							...
							class="glyphicon glyphicon-menu-hamburger"></i> &nbsp;&nbsp;Stop
							Details
						</a>
					</h4>
						...
						<div class="navbar-right" >
							...
							<span class="save2" id="savestops"><img src="images/save.png"></span> 
							
							<span class="glyphicon glyphicon-list3" id="list"></span>
				...
				<form action="transport.html?method=addRoute" id="formRoute"
					...
					<div id="collapseOne" class="accordion-body collapse in">
						<div class="panel-body"
							...
							<input type="hidden" name="stopNoArray" id="stopNoArray" /> <input
								type="hidden" name="stopArrivalTimeArray"
								id="stopArrivalTimeArray" /> <input type="hidden"
								name="stopNameArray" id="stopNameArray" /> <input type="hidden"
								name="stopHaltTimeArray" id="stopHaltTimeArray" /><input
								type="hidden" name="stopDistanceArray" id="stopDistanceArray" />
							<input type="hidden" name="stopDepartureTimeArray"
								id="stopDepartureTimeArray" /> <input type="hidden"
								name="routeCode" id="routeCode" /> <input type="hidden"
								name="parameter" id="methodNameId" />
						</div>
					</div>
				</form>
			</div>
