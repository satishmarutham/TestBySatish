						...
						<h4 class="panel-title">
							...
							<div class="navbar-right">
								...
								<span class="save2">
								 ...
								 <a	href="adminMenu.html?method=transportTypeHome">
						...
						<div class="panel-body">
							<div class="col-md-6"
								...
								<input type="hidden" id="hcollectionType" value="<logic:present name="transportTypeVO" scope="request"><bean:write name="transportTypeVO" property="type"></bean:write></logic:present>" />
									...
									<div class="col-xs-7">
										<input type="text" class="form-control" id="name" value="<logic:present name="transportTypeVO" scope="request"><bean:write name="transportTypeVO" property="transptyname"></bean:write></logic:present>"
											  maxlength="30">
									</div>
								</div>
                                 <br />
