...
<body>
	...
	<div class="col-md-10" id="div1">
		...
		<%-- <div align="right" class="input-group col-md-5" style="margin: 20px 0px;" >
			...
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Class Fee Setup
						 
					</h3></a>
				<div class="navbar-right" >
					
					<span class="glyphicon glyphicon-plus" id="insert"
						 data-toggle="modal" data-target="#myModal" data-toggle="tooltip" data-placement="bottom" title="Add Fee">
					</span>
					
					
					 <span id="savefee" class="glyphicon">
						 <img src="images/save.png"  data-toggle="tooltip" data-placement="bottom" title="Save">
					 </span>
					 
					
					 <a href="adminMenu.html?method=getClassFeeSetup"> <span class="glyphicon glyphicon-list"
							 data-toggle="tooltip" data-placement="bottom" title="List">
					</span></a>
				...
				<div class="panel-body"
					...
					<input type="hidden" id="htermId" value="<logic:present name="classidVal"><bean:write name="termVal"/></logic:present>"/>
						...
						<display:table name="requestScope.getApprovedFeeMasterSetupDetails"  
							requestURI="/classfeesetup.html?method=getEditedFeeSetupDetails"  export="false"
							class="main table" id="allstudent" decorator="com.centris.campus.decorator.FeeMasterSetupDecorator">
						
							<display:column property="sno" title="S.No <img src='images/sort1.png' style='float: right'/>" sortable="true" />
							<display:column property="feecode" title="Fee code"  class="hidden" headerClass="hidden" sortable="true"/>	
							<display:column property="feename" title="Fee Name<img src='images/sort1.png' style='float: right'/>" sortable="true" />
      	...
      	<div class="modal-body" id="scroll">
			<div class="panel-body" id="tabletxt">
						...
						<display:table class="table" id="allstudent" 
							...
							requestURI="/feeSetup.html?parameter=getAllFees"
							decorator="com.centris.campus.decorator.FeeMasterSetupDecorator"
							>
