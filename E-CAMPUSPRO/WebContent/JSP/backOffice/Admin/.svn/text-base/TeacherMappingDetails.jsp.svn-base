			...
			<div class="panel-group" id="accordion" role="tablist"
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						...
						href="teachmap.html?method=adddisplaydetails"><span
						...
						<span
						id="mapedit" class="glyphicon glyphicon-pencil"
						style="font-size: 20px; line-height: 34px; color: #989898;"></span>
					  ...
					  <span id="download" class="glyphicon">
					<img src="images/download.png" style="font-size: 20px; line-height: 34px; color: #989898;">
					 </span>
