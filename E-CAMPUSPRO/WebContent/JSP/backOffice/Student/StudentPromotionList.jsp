...
<body>
	...
	<div class="col-md-10" id="div1">
		...
		<div class="input-group col-md-5">
			<label style="margin: 20px 0px; width: 12%; border: none;"
				class="form-control">Class</label> <select name="typename"
				id="typename" class="form-control" onchange="selectClass()"
				style="width: 30%; margin: 20px 0px; margin-left: 0%;">
				<option value="">------Select--------</option>
				<option value="">1st</option>
				<option value="">2nd</option>
			</select> <label style="margin: 20px 0px; width: 12%; border: none;"
				class="form-control">Sec</label> <select name="typename"
				id="typename" class="form-control" onchange="selectClass()"
				style="width: 30%; margin: 20px 0px; margin-left: 0%;">
				<option value="">------Select--------</option>
