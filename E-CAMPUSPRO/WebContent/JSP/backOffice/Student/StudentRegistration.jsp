				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						...
						<div class="navbar-right">
							...
							<span class="save2" id="save">
							 	<img src="images/save.png" class="save" data-toggle="tooltip" data-placement="bottom" title="Save" />
							</span>
							
							 <a href="adminMenu.html?method=studentList"> 
						...
						<div class="panel-body">
							...
							<div class="col-md-6"
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<select class="form-control" onkeypress="HideError()" name="studentquotaname"
											...
											<option selected="selected"<logic:present name="studentSearchList"><bean:write name="studentSearchList" property="emisNo"></bean:write></logic:present>'></option>
										</select>
									</div>
								</div>
								<br />
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<input type="file" id="studentImageId1" name="studentImage"
											class="custom-file-input myFileInput1" />
									</div>
								</div>
								<br />
								<div class="form-group">
						...
						<div class="panel-body">
							<div class="col-md-6"
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<input type="text" placeholder="" onkeypress="HideError()" readonly="readonly"
											name="dateofBirth" id="dateofBirthId"
											onchange="ageCalculate();" class="form-control"
								...
								<div class="form-group">
									...
									<div class="col-xs-7" id="radiostyle" style="margin-top: 8px">
										<label ><input type="radio" class="radio-inline"
											name="gender" id="genderId"  value="Boy" />Boy</label> <label
											><input type="radio"
											name="gender" class="radio-inline" id="genderId" value="Girl" />Girl</label>
									</div>
								</div>
								<br />
								<div class="form-group">
									<label for="inputPassword" class="control-label col-xs-4"
										...
										Group </label>
									<div class="col-xs-7">
										<select name="bloodGroup" id="bloodGroupId" onkeypress="HideError()"
											class="form-control">
											<option value=""></option>
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<input type="text" name="studentcastename" id="casteId" onkeypress="HideError()"
											maxlength="30" class="form-control"
											value='<logic:present name="studentSearchList"><bean:write name="studentSearchList" property="studentcastename"></bean:write></logic:present>' />
									</div>
								</div>
								<br />
								<div class="form-group">
									...
									<div class="col-xs-7">
										<input type="text" name="nationality" id="nationalityId" onkeypress="HideError()"
								...
								<div class="form-group">
									<label for="inputEmail" class="control-label col-xs-4" id="physicalchlngres"
										style="text-align: right; line-height: 35px;">Reason For PhisicallyChallenge</label>
									<div class="col-xs-7">
