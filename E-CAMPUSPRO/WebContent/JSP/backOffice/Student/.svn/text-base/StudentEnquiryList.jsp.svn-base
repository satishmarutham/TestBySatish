		...
		<div class="col-md-8" id="div2">
			...
			<p style="margin: 16px 0px;">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Student Enquiry Details</span>
			</p>
		</div>
			...
			<div class="panel-heading">
				...
				<div class="navbar-right">
					<a href="adminMenu.html?method=enquiryCreateScreen" id="plus"><span
						class="glyphicon glyphicon-plus" data-toggle="tooltip" data-placement="bottom" title="Add"></span></a>
						 <span
						id="editDesignationId" class="glyphicon glyphicon-pencil" data-toggle="tooltip" data-placement="bottom" title="Edit"></span>
