		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					</a> <span id="editStudent" class="glyphicon glyphicon-pencil"
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<display:table class="table" id="allstudent"
						name="requestScope.studentdetailslist" pagesize="10"
						...
						<display:column property="classSectionId" sortable="true"
							title="Class and section <img src='images/sort1.png' style='float: right'/>"
							media="html"></display:column>
