				...
				<div class="panel-heading" role="tab" id="headingOne">
					<h4 class="panel-title">
						...
						<div class="navbar-right">
							...
							</span> <a href="adminMenu.html?method=studentEnquiryList"><span
					...
					<div class="panel-body">
						<div class="col-md-6"
							...
							<div class="form-group">
								<label for="inputEmail" class="control-label col-xs-4"
									...
									Name </label>
								<div class="col-xs-7">
									<input type="text" name="enq_FirstName" class="form-control"
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<td align="left" valign="middle"><select
										name="enq_studClassId" id="studClassId" class="form-control">
							...
							<div class="form-group">
								<label for="inputPassword" class="control-label col-xs-4"
									...
									Join </label>
								<div class="col-xs-7">
									<input type="text" readonly="readonly" name="enq_dateofJoin"
						...
						<div class="col-md-6"
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<input type="text" name="enq_LastName" id="LastNameId"
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<input type="text" class="form-control" name="enq_source"
							...
							<div class="form-group">
								<label for="inputPassword" class="control-label col-xs-4"
									...
									Year </label>
								<div class="col-xs-7">
									<select name="enq_academicYear" class="form-control"
										id="academicYear">
										<option value=" ">----------Select----------</option>
									</select>
								</div>
					...
					<div class="panel-body">
						<div class="col-md-6"
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<input type="text" class="form-control" name="enq_religion"
						...
						<div class="col-md-6"
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<input type="text" class="form-control" name="enq_age"
						...
						<div class="col-md-6"
							...
							<div class="form-group">
								<label for="inputEmail" class="control-label col-xs-4"
									...
									Type </label>
								<div class="col-xs-7">
									<select name="enq_contacttype" id="contacttypeId"
										class="form-control">
										<option value="">------Select----------</option>
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<input type="text" name="enq_MobileNo" id="MobileNoid"
										...
										maxlength="11" onchange=validateMobileno()
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<textarea name="address" id="paddrs" class="form-control"></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
									<input type="text" class="form-control"
										name="enq_contactmailId" id="contactmailId" maxlength="25"
