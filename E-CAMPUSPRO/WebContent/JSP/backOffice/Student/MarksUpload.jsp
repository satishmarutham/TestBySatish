			...
			<div class="panel-group" id="accordion" role="tablist"
				...
				<div class="panel panel-default">
					...
					<div class="navbar-right">
							...
							<img src="images/save.png" class="save" data-toggle="tooltip" data-placement="bottom" title="Upload Marks">
									
							</Span>	
							
								
						<a href="teachermenuaction.html?method=marksStatus">
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										...
										<input type="text" class="form-control" style="margin-left: -36px;" id="maxmarks" value="<logic:present name="MaxMarks"><bean:write name="MaxMarks" /></logic:present>">
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<%-- <label for="inputPassword" class="col-xs-12"
										 ...
										 --%>
										<input type="text" class="form-control" style="margin-left: -36px;" id="minmarks" value="<logic:present name="MinMarks"><bean:write name="MinMarks" /></logic:present>">
									</div>
								</div>
