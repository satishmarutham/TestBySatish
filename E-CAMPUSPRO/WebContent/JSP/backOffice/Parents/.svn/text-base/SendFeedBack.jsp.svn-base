			...
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					...
					<div class="navbar-right" >
							...
							<a href="parentfeedback.html?method=feedbackentry"><span id="view" class="glyphicon glyphicon-plus2" data-toggle="modal" data-toggle="tooltip" data-placement="bottom" title="List"></span></a>
			...
			<div id="collapseOne" class="accordion-body collapse in">
				...
				<logic:present name="feedbacklist" scope="request">
						<display:table class="remarks table" pagesize="10"
							...
							requestURI="parentMenu.html?method=sendfeedback"
                       ...
                       <display:column title="Select" headerClass="heading1">
	                     ...
	                     <span class="glyphicon glyphicon-trash" onclick="downloadfunction(this)" id='${allstudent.feedbackid},download'></span>
