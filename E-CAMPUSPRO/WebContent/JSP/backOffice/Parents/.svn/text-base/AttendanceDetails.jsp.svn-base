	...
	<div class="col-md-10"
		...
		<div class="panel panel-primary">
			...
			<div class="navbar-right">
				 ...
				 <span id="viewAttendanceId" class="glyphicon glyphicon-pencil2"  data-toggle="tooltip" data-placement="bottom" title="Edit"></span>
		...
		<input	type="hidden" name="studenthidden" id="studentid" value='<logic:present name="attnstudentid"><bean:write name="attnstudentid" />
													</logic:present>'></input>	
				...
				<div class="panel-body"
					...
					<logic:present name="attendancelist" scope="request">
						<display:table class="table" id="allstudent"
							...
							requestURI="/parentMenu.html?method=attendancedetails" export="false" pagesize="12">
