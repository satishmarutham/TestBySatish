	...
	<div class="col-md-10"
		...
		<div class="col-md-7" id="div2">
			...
			<p style="margin: 16px 0px;">
				...
				<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Circular&Remainder </span>
...
<input	type="hidden" name="parenthidden" id="parenthidden" value="<logic:present name="parenthiddenid" ><bean:write name="parenthiddenid" /></logic:present>"/>
