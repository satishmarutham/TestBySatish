			...
			<div class="panel-heading">
				...
				<a href="fuelMenu.html?method=AddFuelDetails"><span
					...
					<span class="glyphicon glyphicon-pencil" id="edit"
						style="cursor:pointer" data-toggle="tooltip" data-placement="bottom" title="Edit"></span>
						
						
				   <span class="glyphicon glyphicon-trash" id="delete"
					style="cursor:pointer" data-toggle="tooltip" data-placement="bottom" title="Delete"></span>
