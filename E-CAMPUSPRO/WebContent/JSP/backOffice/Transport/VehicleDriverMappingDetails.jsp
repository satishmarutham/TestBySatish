					...
					<div class="panel-heading"  id="headingOne">
						<h4 class="panel-title" id="beforeparent">
							...
							<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="color: #767676">
							 <i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Mapping
							</a>
									</h4>
								<div class="navbar-right">
								
									<span class="save"> <img src="images/save.png" id="save" ></span>
									
									 <a href="adminMenu.html?method=getVehicleDriverMapping">
