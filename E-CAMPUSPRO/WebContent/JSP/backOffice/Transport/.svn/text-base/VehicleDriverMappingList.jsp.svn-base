...
<body>
	...
	<div class="col-md-10" id="div1">	<div class="col-md-8" id="div2">
		...
		<logic:present name="successmessagediv" scope="request">
			...
			<div class="panel-heading">
				...
				<span class="glyphicon glyphicon-pencil" id="edit" style="cursor:pointer"></span>
						
				<span class="glyphicon glyphicon-trash" id="delete" style="cursor:pointer"></span>
					
				<span id="xls" class="glyphicon"><img src="images/download.png" class="download"></span>
