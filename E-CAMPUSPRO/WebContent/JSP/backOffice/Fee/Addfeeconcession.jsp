						...
						<h4 class="panel-title">
							...
							<div class="navbar-right">
								...
								<span id="submit" class="save2">
								 ...
								 <span id="view" class="glyphicon glyphicon-list2" data-toggle="tooltip" data-placement="bottom" title="List" ></span>
							</div>
						...
						<div class="panel-body">
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<input type="text" name="Concessionname" class="form-control" id="concessionname"
