					...
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							...
							<div class="navbar-right" >
								...
								<img src="images/download.png" style="margin-top: 1px;margin-left: -3px" class="downloadlast" id="download" data-toggle="modal" data-target="#myModal" data-toggle="tooltip" data-placement="bottom" title="Download" >
