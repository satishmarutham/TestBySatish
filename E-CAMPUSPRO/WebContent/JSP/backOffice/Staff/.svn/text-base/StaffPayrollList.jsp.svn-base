		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right" style="">
					 	...
					 	<span id="editPayroll" class="glyphicon glyphicon-pencil3"  data-toggle="tooltip" data-placement="bottom" title="Edit"></span>
					  
			
                       <img src="images/download.png" class="download" id="iconsimg" style="margin-left: 0px;"
