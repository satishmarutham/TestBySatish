		...
		<div class="col-md-7" id="div2">
			...
			<p style="margin: 16px 0px;">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Staff Payroll Details</span>
			</p>
		</div>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<img src="images/rightline.png" style=" margin-top: -11px;">
					...
					<span id="generatePayslip"><img src="images/payslip.png" style="width: 22px;height: 22px;margin-bottom: 5px"   data-target="#myModal" data-toggle="tooltip" data-placement="bottom" title="Generate Payslip" ></span>
						
				 <a href="adminMenu.html?method=getPayrollList">
					 <span class="glyphicon glyphicon-list4"  data-toggle="tooltip" data-placement="bottom" title="List"></span>
				</a>
							
<!-- 					<img src="images/rightline.png" style=" margin-top: -11px;">
 -->					
					<img src="images/download.png" class="download" id="iconsimg" data-toggle="modal" data-target="#myModal" data-toggle="tooltip" data-placement="bottom" title="Download" >
