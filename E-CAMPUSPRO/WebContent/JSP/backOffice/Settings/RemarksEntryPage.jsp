						...
						<div class="panel-body">
							<div class="col-md-6"
                                ...
                                <div class="form-group">
									...
									<div class="col-xs-7">
										<select name="sectionname" id="sectionid" class="form-control" >
									 <option value=""> </option>
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<textarea name="remarks" id="remarks" class="form-control"><logic:present name="driverlist"><bean:write name="driverlist" property="address"/></logic:present></textarea>
									</div>
								</div>
