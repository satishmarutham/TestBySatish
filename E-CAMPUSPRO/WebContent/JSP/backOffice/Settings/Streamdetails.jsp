		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					<a href="adminMenu.html?method=addStream"><span
				...
				<div class="panel-body"
					...
					<logic:present name="streamDetailsList" scope="request">
						<display:table class="table" id="allstudent"
							name="streamDetailsList" pagesize="10"
							requestURI="/adminMenu.html?method=streamList"
							decorator="com.centris.campus.decorator.StreamDetailsDecorator">

							<display:column property="streamDetailsCheckBox" media="html"
								sortable="true"
							...
							<display:column property="streamName" sortable="true"
								title="Stream<img src='images/sort1.png' style='float: right'/>" />
