		...
		<div class="panel panel-primary">
			...
			<div class="navbar-right" >
				 ...
				 <a	href="adminMenu.html?method=addstage">
				     ...
				     <span id="editStageId" class="glyphicon glyphicon-pencil"   data-toggle="tooltip" data-placement="bottom" title="Edit"></span>
				     
				    
				     
				     <span  id="deleteStageId"class="glyphicon glyphicon-trash"  data-toggle="tooltip" data-placement="bottom" title="Delete"></span>
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<display:table id="allstudent" class="table"  name="requestScope.StageDetails"  export="false" 
					 requestURI="/adminMenu.html?method=StageList"
					 
					pagesize="10" decorator="com.centris.campus.decorator.AddStageDecorator">
					
					<display:column property="check"  sortable="true" title="<input type='checkbox' name='selectall' id='selectall' onClick='selectAll()' />" />
					<display:column property="stageName" sortable="true"  title="Stage Name<img src='images/sort1.png' style='float: right'/>" />
