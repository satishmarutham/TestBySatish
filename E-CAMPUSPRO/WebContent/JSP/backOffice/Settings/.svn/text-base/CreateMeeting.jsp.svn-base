...
<body>
	<div class="col-md-10"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Add Meeting</span>
		</p>
			...
			<div id="collapseOne" class="panel-collapse collapse in"
							...
							<div class="col-md-6"
								...
								<div class="form-group">
									<label for="inputPassword" class="control-label col-xs-4"
										...
										Date</label>
									<div class="col-xs-7">
										<input type="text"  class="form-control" readonly="readonly" name="date" id="dateId"  value="<logic:present name="driverlist" ><bean:write name="driverlist" property="dateofJoin"/></logic:present>"/>
									</div>
								</div>
							...
							<div class="form-group">
									...
									<div class="col-xs-7">
									  ...
									  <logic:present name="classpojo" scope="request">
								        <select name="classname" multiple id="classid" class="form-control" >
									     <!--  <option value=""></option> -->
					...
					<div class="form-group">
                               ...
                               <div class="form-group">
									...
									<div class="col-xs-7">
										<select name="accyear" multiple id="remarksid" class="form-control" >
									<option value=""></option>
							...
							<div class="col-md-6"
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
											<input type="text" name="venueid" id="venueid" class="form-control"  value="<logic:present name="AcadamicYearPlanDetails"  scope="request"><bean:write name="AcadamicYearPlanDetails" property="weekday"/></logic:present>"/>
									</div>
								</div> 
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<select name="sectionname" multiple id="sectionid" class="form-control" >
									<option value=""></option>
								<logic:notEmpty name="ALLACCYEARS" scope="request">
										<logic:iterate id="map" name="ALLACCYEARS" scope="request">
											<option value='<bean:write name='map' property='key'/>'>
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<textarea name="remarks" id="remarks" class="form-control" style=" width: 100%; height: 108px; margin-top: 0px; margin-bottom:"><logic:present name="driverlist"><bean:write name="driverlist" property="address"/></logic:present></textarea>
									</div>
								</div>
