			...
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Communication List
				...
				<div class="navbar-right">
					...
					<!--  <span id="plus" class="save2">
					 ...
					 <span id="plus"
						class="glyphicon glyphicon-plus3"
				...
				<div class="panel-body"
					...
					<logic:present name="remarkslist" scope="request">
						<display:table class="remarks table" pagesize="10"
							...
							<%--  <display:column property="check" sortable="true" onClick='getvaldetails(this)'
								title="<input type='checkbox' name='selectall' id='selectall' onClick='selectAll()' />" 
								
								
								 id="${allstudent.remarkcode}"/>  --%>

							<%-- <display:column property="check" sortable="true" title='Select'  onClick='getvaldetails(this)' id="${allstudent.remarkcode}"></display:column> --%>
