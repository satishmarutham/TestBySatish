...
<body>
	<div class="col-md-10"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">New Quota</span>
		</p>
					...
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							...
							<div class="navbar-right" >
							  ...
							  <a href="adminMenu.html?method=QuotaDetails"><span class="glyphicon glyphicon-list2"
						...
						<div class="panel-body">
							<div class="col-md-6"
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
									<input type="text" name="quotaname" class="form-control" id="quotaid" onblur="registernumberValidation()"
