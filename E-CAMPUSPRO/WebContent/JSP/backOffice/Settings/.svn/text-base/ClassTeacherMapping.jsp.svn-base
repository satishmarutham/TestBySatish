				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							...
							<a href="adminMenu.html?method=getclassandteacherList" >	
							<span id="view" class="glyphicon glyphicon-list2" data-toggle="modal" data-toggle="tooltip" data-placement="bottom" title="List"></span>
							</a>
							</div>
							...
							<div class="col-md-6"
								...
								<div class="col-xs-7">
									...
									<logic:present name="teacherlist" scope="request">
								         <select class="form-control" name="teachername" id="teachernameid">
								           <option value=""> </option>
