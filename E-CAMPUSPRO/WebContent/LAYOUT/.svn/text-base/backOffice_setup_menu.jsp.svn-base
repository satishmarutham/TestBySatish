								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="STRDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="adminMenu.html?method=streamList">Stream Details</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="CLSDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="adminMenu.html?method=classList">Class Details</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="SECDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="adminMenu.html?method=sectionList">Section Details</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="STRDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
									  	...
									  	<li><a href="adminMenu.html?method=QuotaDetails">Quota Details</a></li>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>
						...
						<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="STGDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
										<li><a href="adminMenu.html?method=StageList">Stage Details</a></li>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>			
						...
						<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="DEPDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
										<li><a href="adminMenu.html?method=departmentDetails">Department Details</a></li>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>		
						...
						<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="DESDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
										<li><a href="adminMenu.html?method=designationList">Designation Details</a></li>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>
						...
						<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="SUBDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
										<li><a href="adminMenu.html?method=subjectdetails">Subject Details</a></li>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>				
