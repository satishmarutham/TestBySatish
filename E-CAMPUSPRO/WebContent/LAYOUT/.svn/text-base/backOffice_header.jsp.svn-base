...
<script type="text/javascript">
	...
	function setAcademicYear() {
		$(window.location).attr('href', 'login.html?method=login&accYear='+$("#accYear").val());
	}
</script>
...
<body onload="appendAccYear()">
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal  name="daymap" property="key" value="SETUPDIS">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="adminMenu.html?method=streamList" id="module_1">Setup</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal  name="daymap" property="key" value="STUDDIS">
										<logic:equal value="true" name="daymap" property="value">	
											...
											<li><a href="adminMenu.html?method=studentList" id="module_2">Student</a></li>
						...
						<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal  name="daymap" property="key" value="STFFDIS">
										<logic:equal value="true" name="daymap" property="value">	
											...
											<li><a href="adminMenu.html?method=staffList" id="module_3">Staff</a></li>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>
							...
							<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal  name="daymap" property="key" value="FEEMODDIS">
										...
										<li><a href="adminMenu.html?method=feeDetailsList" id="module_4">Fee</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal  name="daymap" property="key" value="LEAVEDIS">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="teachermenuaction.html?method=leaveRequest" id="module_6">Leave</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal  name="daymap" property="key" value="TRNSPORTDIS">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="adminMenu.html?method=driverList" id="module_7">Transport</a></li>
							...
							<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									...
									<li><a href="reportaction.html?method=studentDetailsReport" id="module_8">Reports</a></li>
		...
		<div class="col-md-2 " id="dropdown"
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
				...
				src="images/person1.png" width="20px" height="20px">&nbsp; Admin
		</div>
	...
	<div class="row"
		...
		<div class="col-md-2" style="padding:0;width:17.6%;">
			<div class="input-group">
				<input type="text" style="padding-left: 31px;" Placeholder="Search......" class="form-control">
		...
		<div class="col-md-8"
			...
			<a href="adminMenu.html?method=Home"><span class="glyphicon glyphicon-home"
		...
		<div class="gb_Va"></div>
		<p>&nbsp;</p>
		<p style="margin-bottom: 5%; font-size: 12px;">
			Last Login &nbsp; : &nbsp;
			<logic:present name="CurrentUser" scope="session">
				<bean:write name="CurrentUser" property="lastLogin" />
			</logic:present>
			<input type="hidden" id="current_academicYear"
				value='<logic:present name="current_academicYear" scope="session">
				<bean:write name="current_academicYear" scope="session" />
			</logic:present>' />
		...
		<p style="margin-bottom: 5%; font-size: 12px;">
			...
			<logic:present name="academicYear" scope="session">
				<select name="accYear" id="accYear" onchange="setAcademicYear()">
					<option value="">-----Select-----</option>
					<logic:iterate id="year" name="academicYear" scope="session">
						<option value='<bean:write name="year" property="accId"  />'>
							<bean:write name="year" property="accName" />
						</option>
					</logic:iterate>
				</select>
			</logic:present>
