...
public interface ParentSettingsService {
	...
	LeaveRequestVo deleteRequestLeaveBDService(int sno, String userid);
	...
	ArrayList<LeaveRequestVo> getleaveApprovalDetailService(
			LeaveRequestVo leavevo);
	...
	ArrayList<LeaveRequestVo> searchleaverequest(String searchTerm);
