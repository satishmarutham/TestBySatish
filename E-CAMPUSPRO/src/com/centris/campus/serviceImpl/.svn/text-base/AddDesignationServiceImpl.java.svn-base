...
public class AddDesignationServiceImpl  implements AddDesignationService{
	...
	
	{
		...
		try {
			...
			String s1=id.getPrimaryKeyID("campus_designation");
	...
	public String deleteDesignationDetails(AddDesignationVO vo) {
		
		return new AddDesignationDaoImpl().deleteDesignationDetails(vo);
	}
