...
public class TeacherServiceImpl implements TeacherService {
	...
	public boolean deleteStaffDetails(AllTeacherDetailsVo obj) {
		...
		return daoObj.deleteStaffDetails(obj);
	}
	...
	public List<ViewallSubjectsVo> getSubjects() {
		...
		try {
			subjectlist = new TeacherDaoImpl().getSubjects();
		} catch (Exception se) {
	...
	public boolean teacherregister(TeacherForm obj) {
		...
		try {
			...
			/* teacherDetailsForm.setRole(obj); */
			...
			teacherPojo.setPermanentadd(obj.getPermanentadd());
			teacherPojo.setPresentadd(obj.getPresentadd());
			teacherPojo.setTeacheremail(obj.getTeacheremail());
