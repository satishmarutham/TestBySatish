...
public class SectionServiceImpl implements SectionService{
	...
	@Override
	public synchronized boolean insertCampusClassSectionService(
		...
		try {
			...
			sectionPojo.setSecDetailsId(campusClassSectionForm
					.getSecDetailsId());
			sectionPojo.setSecDetailsName(campusClassSectionForm
					.getSecDetailsName());
	...
	@Override
	public synchronized boolean updateCampusClassSectionService(
			SectionForm campusClassSectionForm) throws Exception {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
	...
	@Override
	public synchronized boolean deleteCampusClassSectionService(
			SectionForm campusClassSectionForm) throws Exception {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
     ...
     return campusClassSectionDao.deleteCampusClassSectionDao(sectionPojo);
	}

	@Override
	public synchronized List<SectionForm> getCampusClassSectionAndClassDetailsService()
			throws Exception {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		...
		classSectionPojoList = campusClassSectionDao
				.getCampusClassSectionAndClassDetailsDao();
		try {
	...
	@Override
	public synchronized List<SectionForm> getCampusClassDetailsIDandClassDetailsNameService()
			throws Exception {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		...
		List<SectionPojo> classSectionPojoList = new ArrayList<SectionPojo>();
		classSectionPojoList = campusClassSectionDao
				.getCampusClassDetailsIDandClassDetailsNameDao();
		try {
			for (SectionPojo pojoList : classSectionPojoList) {
				SectionForm sectionForm = new SectionForm();
				sectionForm.setSecDetailsId(pojoList.getSecDetailsId());
