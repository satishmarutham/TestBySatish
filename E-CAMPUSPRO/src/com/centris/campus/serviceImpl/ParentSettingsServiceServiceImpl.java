...
public class ParentSettingsServiceServiceImpl implements ParentSettingsService {
	...
	public LeaveRequestVo deleteRequestLeaveBDService(int sno,String userid) {
		...
		try {
			...
			asslist = parentdao.deleteRequestLeaveDao(sno,userid);
	...
	public ArrayList<LeaveRequestVo> searchleaverequest(String searchTerm) {
		...
		try {
			...
			leavelist = parentdao.searchleaverequest(searchTerm);
