...
public class ParentExamdetailsBD {
	...
	public LeaveRequestVo deleteRequestLeaveBD(int sno, String userid) {

		return service.deleteRequestLeaveBDService(sno,userid);
	}
	...
	public ArrayList<LeaveRequestVo> searchleaverequest(String searchTerm) {
		// TODO Auto-generated method stub
		return service.searchleaverequest(searchTerm);
	}
