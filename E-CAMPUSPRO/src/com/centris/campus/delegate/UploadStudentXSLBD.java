...
public class UploadStudentXSLBD {
	...
	public Set<UploadStudentXlsVO> insertEmpXSL(List<UploadStudentXlsPOJO> list, String username, String duplicate) {
		// TODO Auto-generated method stub
		return new UploadStudentXSLServiceIMPL().insertEmpXSL(list, username,duplicate);
	}
