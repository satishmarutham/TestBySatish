...
public class FuelMaintenanceAction extends DispatchAction {
	...
	public ActionForward insertFuelDetails(ActionMapping mapping,
		...
		try {
			...
			addFuellist.setVehicleCode(request.getParameter("vehiclecode"));
			...
			addFuellist.setDriverCode(request.getParameter("drivercode"));
			addFuellist.setFuelCode(request.getParameter("fuelcode"));
