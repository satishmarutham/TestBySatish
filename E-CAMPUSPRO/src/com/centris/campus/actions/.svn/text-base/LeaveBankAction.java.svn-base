...
public class LeaveBankAction extends DispatchAction {
	...
	public ActionForward submit(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			System.out.println("leave banck action");
			...
			String delegate = new LeaveBankDelegate()
					.insertLeaveBankDelegate(aform);
	...
	public ActionForward leavebankexcel(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in ClassAction : leavebankexcel  Starting");
		...
		System.out.println("DOWNLOADING Leave bank EXCEL");
			...
			String sourceFileName = request
					.getRealPath("Reports/LeaveBankDetailsXLSReport.jrxml");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in ClassAction : leavebankexcel   Ending");
				return null;
