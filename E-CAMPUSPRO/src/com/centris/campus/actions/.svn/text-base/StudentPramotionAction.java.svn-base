...
public class StudentPramotionAction extends DispatchAction {
	...
	public ActionForward insertStudentPromotion(ActionMapping mapping,
		...
		try {
			...
			String[] studentidval = request
					.getParameterValues("studentidvalues[]");
			String fromstreamval = request.getParameter("fromstream");
			String[] tostreamval = request
					.getParameterValues("tostreamvalues[]");
			String fromclassval = request.getParameter("fromclass");
			String[] toclassval = request.getParameterValues("toclassvalues[]");
			String fromacadamicyearval = request
					.getParameter("fromacadamicyear");
			String[] toacadamicyearval = request
					.getParameterValues("toacadamicyearvalues[]");
			String fromsectionval = request.getParameter("fromsection");
			String[] tosectionvaluesval = request
					.getParameterValues("tosectionvalues[]");
			String[] promotionstatus = request
					.getParameterValues("pramotionstatus[]");
						...
						for (int l = k; l <= k; l++) {
							for (int m = l; m <= l; m++) {
								for (int n = m; n <= m; n++) {
									...
									// callnig business delegator class
