...
public class StaffAttendanceReportAction extends DispatchAction{
	...
	public ActionForward staffAttendanceExcelReport(ActionMapping mapping,
		...
		try {
			...
			ArrayList<StaffAttendanceVo> MasterList = new StaffAttendanceReportBD()
					.getStaffAttendanceReportBD(vo);
...
*/
			...
			String sourceFileName = request
					.getRealPath("Reports/StaffAttendancePDFReport.jrxml");
			JasperDesign design = JRXmlLoader.load(sourceFileName);
	...
	public ActionForward getTeachernameAction(ActionMapping mapping,
		...
		try {
			...
			if(teachertype.equalsIgnoreCase("teaching")){
				...
				List<AllTeacherDetailsVo> teachinglist = new StaffAttendanceReportBD().getTeachingListBD(vo);
				...
				List<AllTeacherDetailsVo> nonteachinglist = new StaffAttendanceReportBD().getNonTeachingListBD(vo);
