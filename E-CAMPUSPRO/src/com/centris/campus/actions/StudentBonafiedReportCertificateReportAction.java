...
public class StudentBonafiedReportCertificateReportAction extends DispatchAction {
	...
	public ActionForward studentBonafiedCertificateReportAction(ActionMapping mapping, ActionForm form,
	...
	public ActionForward studentBonafiedCertificatePDFReport (ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		try {
	       ...
	       Date currentdate = HelperClass.getCurrentSqlDate();
			...
			String filepath = request
					.getRealPath("Reports/Bonafide.jrxml");
