	...
	*/}
	...
	public synchronized List<PermissionVO> getPermissionByRole(String roleCode) {
		...
		try {
			...
			PermissionVO permissionVO = null;
			ps_Permission = (PreparedStatement)JDBCConnection.getStatement(UserRolePermissionSqlConstatnts.GET_PERMISSION_BY_ROLE);
	...
	public synchronized UserRolePermissionVO insertRolePermission(UserRolePermissionForm userRolePermission) {
		...
		try {
			...
			ps_Permission = (PreparedStatement)JDBCConnection.getStatement(UserRolePermissionSqlConstatnts.INSERT_ROLE_PERMISSION_MAPPING);
	...
	public synchronized PermissionVO removePermission(String roleCode,
		...
		try {
			...
			ps_Permission = (PreparedStatement)JDBCConnection.getStatement(UserRolePermissionSqlConstatnts.DELETE_ROLE_PERMISSION_MAPPING);
			ps_Permission.setString(1, roleCode);
	...
	public synchronized List<RoleMasterPojo> getRoles()
	  ...
	  psgetUsers=(PreparedStatement)JDBCConnection.getStatement(UserRolePermissionSqlConstatnts.GET_ROLES);
