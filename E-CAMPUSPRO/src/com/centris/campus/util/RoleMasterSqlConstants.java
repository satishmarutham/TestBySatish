...
public class RoleMasterSqlConstants {
	...
	// Role master
	public static final String GET_ROLES = "select RoleCode,RoleName,Description from campus_role where IsDefault='N'";
	public static final String ADD_ROLE = "insert into campus_role(RoleCode,RoleName,Description,createdby) values(?,?,?,?)";
	public static final String VALIDATE_ROLE_NAME = "select count(*) RoleName from campus_role where RoleName=?";
	public static final String UPDATE_ROLE = "update campus_role set RoleName=?,Description=?,modifiedby=?,modifiedtime=? where RoleCode=?";
