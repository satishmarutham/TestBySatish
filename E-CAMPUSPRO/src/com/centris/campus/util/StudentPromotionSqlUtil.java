...
public class StudentPromotionSqlUtil {
	...
	public static final String STUDENT_REGISTRATION = "insert into campus_student(student_id_int,student_rollno,student_admissionno_var,fms_classstream_id_int,fms_acadamicyear_id_int,classdetail_id_int,classsection_id_int,student_regno_var,student_fname_var,student_lname_var,student_dob_var,student_gender_var,student_bloodgroup_var,student_age_int,student_imgurl_var,student_doj_var,student_religion_var,student_nationality_var,student_scholorship_var,student_promotionstatus,student_physicallychallenged,student_identificationmarks_var,student_grade,student_fathername_var,student_mothername_var,student_gaurdianname_var,student_fatherqualification_var,student_fathermobileno_var,student_mothermobileno_var,student_motherqualification_var,student_siblingname_var,student_siblingclass_var,student_status_var,student_prehistory_var,student_remarks_var,createuser,createdate,student_quota,student_father_mailid,student_mother_mailid,student_gardian_mailid,student_gardian_mobileno,student_caste,student_application_no,isTransport,isHostel,isConcession,isRTE,TransportType,StageId) values (?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,?,?,?,?,?)";
