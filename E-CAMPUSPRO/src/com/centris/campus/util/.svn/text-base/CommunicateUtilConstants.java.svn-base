...
public class CommunicateUtilConstants {
	...
	public static final String GET_SECTION_DETAILS = "select ccd.classdetail_id_int,ccd.classdetails_name_var,cls.classsection_id_int,cls.classsection_name_var from campus_classdetail ccd,campus_classsection cls where ccd.classdetail_id_int=cls.classdetail_id_int and cls.classdetail_id_int=?";
